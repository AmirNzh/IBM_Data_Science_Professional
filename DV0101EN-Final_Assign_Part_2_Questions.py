...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            figure=px.line(average_sales,
                x='Vehicle_Type',
                y='Automobile_Sales',
                title="Average Automobile Sales fluctuation by Vehicle Types"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rec= recession_data#.groupby('Unemployment_Rate','Vehicle_Type')['Advertising_Expenditure'].sum().reset_index()
        R_chart4 = dcc.Graph(
...
# Polt 4 Total Advertisement Expenditure for each vehicle using pie chart
